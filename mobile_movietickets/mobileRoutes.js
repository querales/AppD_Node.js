...
module.exports = function(app) {
  ...
  app.get('/loadDB', function (request, response) {
    ...
    app.get('/buy', function (req, response) {
...
app.get('/refund', function (req, response) {
            //request('http://beta-movietix.demo.appdynamics.com/Movie/', function() {response.send ("buy")})
                        //request('http://staging-movietix.demo.appdynamics.com/Movie/', function() {response.send ("buy")})
                                    //request('http://dev-movietix.demo.appdynamics.com', function() {response.send ("refund")})     
 //                                      request('http://staging-movietix.demo.appdynamics.com/api/search/c3971cdd-acc2-43ba-af17-00aa8aee9d3d', funcRedis(function(){response.send ("refund")})
//)
                                     request('http://MOVIE_TIX/api/search/c3971cdd-acc2-43ba-af17-00aa8aee9d3d', funcRedis(function(){response.send ("refund")})
)
...
function httpCall(BT) {
        request('http://api.partner.imdb.com', function(error,response,body) {
                request('http://api.twitter.com', function(err,resp,b) {          
                         if (err) {console.log ("error: " +err)}
                                        else{ 
                                                        console.log("http call from twitter was good  3 "+b)
                                                                        request('http://api.google.maps.com', function(error,response,body) {
                                                                                      // request('http://api.partner.imdb.com', function(error,response,body) {                 
                                                                                                                                 if (error) {console.log ("error: " +error)}
                                                                                                                                                                            else {  
                                                                                                                                                                                                                                                   console.log(" maps.googleapis OK and should be last.... "+ body)
                                                                                                                                                                                                                                                                                                        BT()
                                                                                                                                                                                                                                                                                                              						    }	
                                                                                                                                                                                                                                                                                                              						                                       })
